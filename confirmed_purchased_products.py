...
CONFIRMED_PURCHASED_NON_BOM_SKUS = (
    ...
    "UNI-P-ACC02-MIS951", "UNI-P-ACC02-MIS952", "USB-P-ACC01-HRD050", "USB-P-ACC01-HRD051",
...
if len(CONFIRMED_PURCHASED_NON_BOM_SKUS) != 71 or len(CONFIRMED_PURCHASED_NON_BOM_KEYS) != 71:
    raise RuntimeError("Confirmed purchased product registry must contain 71 unique SKUs.")
