"""Furnibox Product Engine desktop interface (first working version)."""
...
class FurniboxApp(tk.Tk):
    ...
    def _build_ui(self):
        ...
        action_specs = [
            ...
            ("7. Paruošti visų produktų importą", lambda: self.run_script(first_existing("product_import_v4.py", "product_import_v3.py", "product_import_v2.py", "product_import.py"))),
        ]
        ...
        self.bom_button = ttk.Button(
            actions,
            text="8. Paruošti BOM importą (dar rengiama)",
            command=self._bom_not_ready,
